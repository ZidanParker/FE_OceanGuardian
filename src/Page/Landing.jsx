      ...
      <div className="flex-grow pt-32 md:pt-52">
        ...
        <div className="bg-white mt-5 md:mt-50 py-20 md:py-36">
          ...
          <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5 px-4">
            {[
              { src: "assets/laporan.png", title: "Laporan Real-Time", description: "Fitur ini menyediakan informasi dari laporan pengguna lain secara real-time." },
              { src: "assets/ikan.png", title: "Pelaporan Penangkapan Ikan Ilegal", description: "Fitur ini memungkinkan pengguna untuk melaporkan adanya penangkapan ikan ilegal yang mereka temukan." },
              { src: "assets/sampah.png", title: "Pelaporan Sampah Laut", description: "Fitur ini memungkinkan pengguna untuk melaporkan adanya sampah laut yang mereka temukan." },
              { src: "assets/statistik.png", title: "Statistik Pelaporan", description: "Fitur ini memungkinkan pengguna melihat statistik pelaporan per tahun maupun per bulan." },
            ].map((feature, index) => (
