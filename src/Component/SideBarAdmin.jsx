...
const SidebarAdmin = ({ isOpen, toggleSidebar, onLogoutNotification }) => {
  ...
  return (
    <aside className={`fixed inset-y-0 left-0 md:static md:w-64 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 bg-blue-500 text-white p-6 flex flex-col transition-transform duration-200 ease-in-out z-50`}>
      ...
      <nav className="flex flex-col space-y-4 flex-grow">
        <a href="/dashboardadmin" className="flex items-center space-x-2 px-4 py-2 hover:bg-blue-600 rounded-md">
          <img src={dashboardIcon} alt="Dashboard Icon" className="w-6 h-6" />
          <span>Dashboard</span>
        </a>
        <a href="/dokumentasiadmin" className="flex items-center space-x-2 px-4 py-2 hover:bg-blue-600 rounded-md">
          <img src={dokumentasiIcon} alt="Dokumentasi Laporan Icon" className="w-6 h-6" />
          <span>Dokumentasi</span>
        </a>
        <a href="/helpadmin" className="flex items-center space-x-2 px-4 py-2 hover:bg-blue-600 rounded-md">
